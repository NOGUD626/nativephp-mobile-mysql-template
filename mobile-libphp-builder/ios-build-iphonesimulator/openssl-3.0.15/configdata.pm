...
our %config = (
    ...
    "perlargv" => [
        ...
        "--prefix=/Users/noguchi/Desktop/nativephp-mobile-mysql-template/mobile-libphp-builder/ios-build-iphonesimulator/install",
        "no-shared",
        "no-tests"
    ],
    "perlenv" => {
...
unless (caller) {
    ...
    use lib '/Users/noguchi/Desktop/nativephp-mobile-mysql-template/mobile-libphp-builder/ios-build-iphonesimulator/openssl-3.0.15/util/perl';
    use OpenSSL::fallback '/Users/noguchi/Desktop/nativephp-mobile-mysql-template/mobile-libphp-builder/ios-build-iphonesimulator/openssl-3.0.15/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/noguchi/Desktop/nativephp-mobile-mysql-template/mobile-libphp-builder/ios-build-iphonesimulator/openssl-3.0.15/Configurations';
        use gentemplate;
